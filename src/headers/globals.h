...
constexpr float PLAYER_MOVEMENT_SPEED = 6;
...
constexpr int WINDOW_WIDTH = 192 * 9;
constexpr int WINDOW_HEIGHT = 108 * 9;
constexpr int SCREEN_WIDTH = 192 * 7;
constexpr int SCREEN_HEIGHT = 108 * 7;
